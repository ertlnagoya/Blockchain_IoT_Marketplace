...
async function main() {
  ...
  // 写入文件
  await writeFile('/Users/lyhl/Downloads/vscode_workspace/IoTMarket/ssi/did/issuer/didDocument.json', JSON.stringify(didDocument, null, 2), 'utf8');
  await writeFile('/Users/lyhl/Downloads/vscode_workspace/IoTMarket/ssi/did/issuer/keyPair.json', JSON.stringify(keyPair, null, 2), 'utf8');
